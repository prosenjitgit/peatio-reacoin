RSpec.describe Peatio::Rea::Wallet do
  let(:wallet) { Peatio::Rea::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Rea::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Rea::Wallet::SUPPORTED_SETTINGS))
    end
  end
